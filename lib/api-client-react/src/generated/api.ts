 ...
 */
export const getMyListings = async ( options?: Parameters<typeof customFetch>[1]): Promise<Listing[]> => {
 ...
 */
export const getFeaturedListings = async (params?: GetFeaturedListingsParams, options?: Parameters<typeof customFetch>[1]): Promise<Listing[]> => {
 ...
 */
export const getRequests = async (params?: GetRequestsParams, options?: Parameters<typeof customFetch>[1]): Promise<HardwareRequest[]> => {
 ...
 */
export const createRequest = async (hardwareRequestInput: HardwareRequestInput, options?: Parameters<typeof customFetch>[1]): Promise<HardwareRequest> => {
...
export const getCreateRequestMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createRequest>>, TError,{data: BodyType<HardwareRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createRequest>>, TError,{data: BodyType<HardwareRequestInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createRequest>>, {data: BodyType<HardwareRequestInput>}> = (props) => {
          const {data} = props ?? {};
 ...
 */
export const getMyRequests = async ( options?: Parameters<typeof customFetch>[1]): Promise<HardwareRequest[]> => {
...
export const getGetMyRequestsQueryOptions = <TData = Awaited<ReturnType<typeof getMyRequests>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMyRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetMyRequests<TData = Awaited<ReturnType<typeof getMyRequests>>, TError = ErrorType<void>>(
...
export const updateRequest = async (id: number,
    hardwareRequestUpdate: HardwareRequestUpdate, options?: Parameters<typeof customFetch>[1]): Promise<HardwareRequest> => {
...
export const getUpdateRequestMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateRequest>>, TError,{id: number;data: BodyType<HardwareRequestUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateRequest>>, TError,{id: number;data: BodyType<HardwareRequestUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateRequest>>, {id: number;data: BodyType<HardwareRequestUpdate>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 */
export const getSavedListings = async ( options?: Parameters<typeof customFetch>[1]): Promise<Listing[]> => {
...
export const getGetSavedListingsQueryOptions = <TData = Awaited<ReturnType<typeof getSavedListings>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSavedListings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetSavedListings<TData = Awaited<ReturnType<typeof getSavedListings>>, TError = ErrorType<void>>(
 ...
 */
export const saveListing = async (saveListingInput: SaveListingInput, options?: Parameters<typeof customFetch>[1]): Promise<SavedConfirmation> => {
...
export const getSaveListingMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof saveListing>>, TError,{data: BodyType<SaveListingInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof saveListing>>, TError,{data: BodyType<SaveListingInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof saveListing>>, {data: BodyType<SaveListingInput>}> = (props) => {
          const {data} = props ?? {};
 ...
 * @summary Save a listing (auth required)
 */
export const useSaveListing = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof saveListing>>, TError,{data: BodyType<SaveListingInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const unsaveListing = async (listingId: number, options?: Parameters<typeof customFetch>[1]): Promise<void> => {
...
export const getUnsaveListingMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof unsaveListing>>, TError,{listingId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof unsaveListing>>, TError,{listingId: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof unsaveListing>>, {listingId: number}> = (props) => {
 ...
 * @summary Remove a saved listing
 */
export const useUnsaveListing = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof unsaveListing>>, TError,{listingId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getMarketplaceStats = async ( options?: Parameters<typeof customFetch>[1]): Promise<MarketplaceStats> => {
