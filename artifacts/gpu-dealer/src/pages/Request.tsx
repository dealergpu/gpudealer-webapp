...
import { useCreateRequest, HardwareRequestInputCategory, HardwareRequestInputConditionPreference, HardwareRequestInputRequiredBy, getGetRequestsQueryKey, getGetMyRequestsQueryKey } from "@workspace/api-client-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(val) => form.setValue("conditionPreference", val as any)}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(val) => form.setValue("requiredBy", val as any)}
                >
